...
const App = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titulo}>a las {Hora}:{Min}</Text>
        ...
        onRequestClose={() => setShowModal(false)}>
          <View style={styles.modalContainer}>
            ...
            <Text style={styles.modalText}>El tiempo</Text>
              ...
              <Text style={styles.modalText}>para Cabos y Sargentos</Text>
              <TouchableOpacity
        ...
        <View style={styles.modalContainer}>
          ...
          <Text style={styles.modalText}>El tiempo</Text>
            <Icon name="clock-o" size={255} color="#019063" />
            <Text style={styles.modalText}>Se ha terminado</Text>
            <Text style={styles.modalText}>para Sargentos</Text>
            <TouchableOpacity
              style={styles.closeButton}
              onPress={() => setShowModal(false)}
            >
      ...
      <Pressable style={styles.button} onPress={() => router.push('/Sargento')}>
