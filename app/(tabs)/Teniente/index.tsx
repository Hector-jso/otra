  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cosas}>
        ...
        <Pressable style={styles.button} onPress={() => router.push('/Teniente/crearAlarm')}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={styles.colum}>
                ...
                <TouchableOpacity onPress={() => router.push(`/Teniente/reloj/${item.id}`)}>
                  <Text style={styles.text}>{item.nombre}</Text>
                  <Text style={styles.text}>{item.hora}:{item.min}</Text>
                </TouchableOpacity>
                </View>
              <View style={styles.columEdit}>
                <TouchableOpacity onPress={() => router.push(`/Teniente/editAlarm/${item.id}`)}>
