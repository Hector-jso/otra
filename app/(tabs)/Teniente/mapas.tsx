  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cosas}>
        ...
        <Pressable style={styles.button} onPress={() => router.push('Teniente/crearMapa')}>
          ...
          return (
            <View style={[styles.colum, isExpired && styles.expired]}>
              <View style={styles.columText}>
                <TouchableOpacity onPress={() => router.push(`Teniente/Mapa/${item.id}`)}>
                  <Text style={styles.text}>{item.nombre}</Text>
                </TouchableOpacity>
                {isExpired && <Text style={styles.expiredText}>Expirado</Text>}
              </View>
              <View style={styles.columEdit}>
                <TouchableOpacity onPress={() => router.push(`Teniente/editMapa/${item.id}`)}>
