...
const CreateScreen = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      router.push('/Teniente/'); // Navega de vuelta a la pantalla principal
    } catch (error) {
  ...
  return (
    <View style={styles.todo}>
      <View style={styles.container}>
        ...
        <Pressable style={styles.regresar} onPress={() => router.push('Teniente/')}>
      ...
      <View style={styles.topbar}>
        <ImageBackground
          ...
          <View style={styles.divisa}>
            <Image
              source={require('../../../assets/images/Teniente.png')}
